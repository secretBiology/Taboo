...
public class Game extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.edit().putInt(GameVariables.CURRENT_WORD, 0).apply();
        ...
        wordData = new AllWords().getAllWords();
        ...
        boolean justStarted = savedInstanceState == null || savedInstanceState.getBoolean(SavedGame.IS_DIALOGUE_OPEN) && savedInstanceState.getInt(SavedGame.CURRENT_ROUND) == 1;
        ...
        if (savedInstanceState != null && !justStarted) {
            ...
            db.edit().putInt(GameVariables.CURRENT_WORD, savedInstanceState.getInt(SavedGame.CURRENT_WORD)).apply();
